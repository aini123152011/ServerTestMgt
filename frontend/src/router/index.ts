  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'provision', name: 'Provision', component: () => import('@/views/ProvisionList.vue') },
        { path: 'firmware', name: 'Firmware', component: () => import('@/views/FirmwareList.vue') },
        { path: 'operations', name: 'Operations', component: () => import('@/views/OperationsPanel.vue') },
        { path: 'reports/:id', name: 'ReportView', component: () => import('@/views/ReportView.vue') },
        { path: 'settings/cicd', name: 'CICDSettings', component: () => import('@/views/CICDSettings.vue') },
      ],
    },
  ],
})
